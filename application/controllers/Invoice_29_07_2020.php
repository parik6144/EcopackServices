...
class Invoice extends CI_Controller
{
    ...
    public function TransportAddConsignment()
    {
       
        if (isset($_POST['transport_invoice_rate_id']) && $_POST['transport_invoice_rate_id'] != '')
        { 
            $this->load->model('Mdl_consignee_billing');
            $data['consignee_billing']=$this->Mdl_consignee_billing->getconsignee_billing("","","","","");
            //echo "<pre>";
            $data['transport_consignments']=$this->Mdl_invoice->getpendingtransportconsignments($_POST);
        ...
        else
        {
            ...
            if($data['record']['invoice']->invoice_type_id=="3")
            {
                ...
                if(empty($data['extra']))
                {
                    ...
                    elseif ($data['record']['invoice']->consignee_id=="13" || $data['record']['invoice']->consignee_id=="50") {
